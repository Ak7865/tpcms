...
const routeLabels = {
  ...
  '/t&p/dashboard': 'T&P Coordinator Dashboard',
  '/company/dashboard': 'Company Dashboard',
  '/students/dashboard': 'Student Dashboard',
}

const notifications = [
  { id: '1', text: 'New company registration pending approval', time: '2 min ago', unread: true },
  { id: '2', text: '15 new job applications received', time: '18 min ago', unread: true },
  { id: '3', text: 'Placement drive scheduled for next week', time: '3 hours ago', unread: false },
]
              ...
              <div className="px-4 py-3">
                ...
                <div className="space-y-1">
                  {[
                    ...
                    { label: 'Student Dashboard', path: '/students/dashboard' },
                    { label: 'Company Dashboard', path: '/company/dashboard' },
                    { label: 'T&P Dashboard', path: '/t&p/dashboard' },
                  ].map(item => (
                    <div
                      key={item.path}
